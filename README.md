...
This repository provides an extensive framework for building, training, and evaluating neural networks using TensorFlow. It is designed for flexibility and ease of use, allowing users to configure various aspects of neural networks and data processing through TOML files. The project is ideal for both educational purposes and practical applications in machine learning and deep learning.
