...
nn_data = nn_data.reshape(nn_data.shape[0], nn_data.shape[1], nn_data.shape[2], 1) # there's a neater way of doing this!
...
model.compile(optimizer='adam',
              ...
              metrics=['MeanSquaredError']) # accuracy is not the right metric here

model.summary()

model.fit(nn_data, predictions, epochs=600, verbose=2, validation_split=0.05) # validation_split automatically generates validation data; all data is shuffled by default
