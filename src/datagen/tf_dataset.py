...
def write_tfrecord(file_path: Path, num_samples: int, dataset_config, running_stats) -> None:
    """
...
def transform_and_save_dataset(original_dataset_path: Path, feature_stats: dict, label_stats: dict, output_dataset_path: Path, normalize: bool = True, quantize: bool = False, num_quantization_bins: int = 256):
    """
